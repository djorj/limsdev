...
// extends- 
{
     ...
     * <ul>
     * <li>full name: certificate.certificateid
     * <li>column size: 4
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: certificate.companyid
     ...
     */
    public void copy(CertificateBean bean) {
    ...
    public String toString() {
        return   "\n[certificate] "
                 + "\n - certificate.certificateid = " + (certificateid_is_initialized ? ("[" + (certificateid == null ? null : certificateid.toString()) + "]") : "not initialized") + ""
                 + "\n - certificate.companyid = " + (companyid_is_initialized ? ("[" + (companyid == null ? null : companyid.toString()) + "]") : "not initialized") + ""
                 + "\n - certificate.name = " + (name_is_initialized ? ("[" + (name == null ? null : name.toString()) + "]") : "not initialized") + ""
                 + "\n - certificate.logo = " + (logo_is_initialized ? ("[" + (logo == null ? null : logo.toString()) + "]") : "not initialized") + ""
            ;
    }
