...
<input name="contractid" type="hidden">
<input name="appealid" type="hidden">
<input name="actid" type="hidden">
...
function showmsg() {
    $("#msgModal").modal("show");
    $("#frmclosingbody").load("api/load_closing_form.jsp?contractid="+$("#contract").val()+"&actid="+$("#act").val()+"&appealid="+$("#appeal").val(), function (json) {
        var cd = new Date();
    ...
    function submitContract() {
        ...
        if(sampletype > 0 && maxnum === 0)
            ...
            alertError('<%=trs.t("შეცდომა")%>','<%=trs.t("აირჩიეთ ფასი ან რაოდენობა!")%>','<%=trs.t("დახურვა")%>');
        else {
...
//            $("#act").select2('data', {id: rs.data, text: rs.data.num, selected: true});
    ...
    $(document).on("change", "#sample", function () {
        ...
        $("#frmsampletype input[name='appealid']").val($("#appeal").val());
        $("#frmsampletype input[name='actid']").val($("#act").val());
        }
        $("#sample-box").show();
    });
...
function cbSetResearch(rs)
{
    ...
    $(document).on("click", ".addnew", function (e) {
        ...
        var maxnum = $("#maxnum"+$fg).val().length;
        if(sampletype === 0 && labtest === 0 && maxprice === 0)
            alertError('<%=trs.t("შეცდომა")%>','<%=trs.t("არაა არჩეული არც ნიმუში არც კვლევა და არც ფასი!")%>','<%=trs.t("დახურვა")%>');
...
<section class="col col-md-3"><label class="input"> <i class="icon-append fa fa-money"></i><input value="'+maxprice+'" name="maxprice'+$fg+'" id="maxprice'+$fg+'" class="testprice" placeholder="<%=trs.t("მაქს. ფასი")%>" type="text" min="0"><b class=\"tooltip tooltip-top-right\"><i class=\"fa fa-money txt-color-teal\"></i> <%=trs.t("ფასი")%></b></label></section>\n\
<section class="col col-md-3"><label class="input"> <i class="icon-append fa fa-list-ol"></i><input value="'+maxnum+'" name="maxnum'+$fg+'" id="maxnum'+$fg+'" placeholder="<%=trs.t("მაქს. რაოდენობა")%>" type="text" min="0"><b class=\"tooltip tooltip-top-right\"><i class=\"fa fa-list-ol txt-color-teal\"></i> <%=trs.t("რაოდენობა")%></b></label></section>\n\
...
<section class="col col-md-3"><label class="input"> <i class="icon-append fa fa-money"></i><input value="'+maxprice+'" class="testprice" name="edmaxpri'+$fg+'" placeholder="<%=trs.t("მაქს. ფასი")%>" type="text" min="0"><b class=\"tooltip tooltip-top-right\"><i class=\"fa fa-money txt-color-teal\"></i> <%=trs.t("ფასი")%></b></label></section>\n\
<section class="col col-md-3"><label class="input"> <i class="icon-append fa fa-list-ol"></i><input value="'+maxnum+'" name="edmaxnum'+$fg+'" placeholder="<%=trs.t("მაქს. რაოდენობა")%>" type="text" min="0"><b class=\"tooltip tooltip-top-right\"><i class=\"fa fa-list-ol txt-color-teal\"></i> <%=trs.t("რაოდენობა")%></b></label></section>\n\
