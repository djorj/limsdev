...
// extends- 
{
     ...
     * <ul>
     * <li>full name: company.companyid
     * <li>column size: 4
     ...
     */
    public void copy(CompanyBean bean) {
    ...
    public String toString() {
        return   "\n[company] "
                 + "\n - company.companyid = " + (companyid_is_initialized ? ("[" + (companyid == null ? null : companyid.toString()) + "]") : "not initialized") + ""
                 + "\n - company.name = " + (name_is_initialized ? ("[" + (name == null ? null : name.toString()) + "]") : "not initialized") + ""
                 + "\n - company.logo = " + (logo_is_initialized ? ("[" + (logo == null ? null : logo.toString()) + "]") : "not initialized") + ""
                 + "\n - company.url = " + (url_is_initialized ? ("[" + (url == null ? null : url.toString()) + "]") : "not initialized") + ""
            ;
    }
