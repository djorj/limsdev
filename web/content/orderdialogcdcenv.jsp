...
%>
<script>
$.post("content/ordercdcgeneralenv.jsp", {}, function(data) { $("#s2").html(data); });
...
<ul class="nav nav-tabs bordered" id="ptabs">
    <li class="active">
        <a data-toggle="tab" href="content/ordercdcgeneralenv.jsp" data-target="#s2"><%=trs.t("ზოგადი ინფორმაცია")%></a>
    </li>
    <li>
        <a data-toggle="tab" href="content/ordercdccustomerenv.jsp" data-target="#s3"><%=trs.t("დამკვეთის მოთხოვნები")%></a>
    </li>
    <li>
        <a data-toggle="tab" href="content/ordercdcepidenv.jsp" data-target="#s4"><%=trs.t("ნიმუშის ინფორმაცია")%></a>
    </li>
</ul>
