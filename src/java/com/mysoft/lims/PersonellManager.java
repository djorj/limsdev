...

{
     ...
     */
    public static final int ID_INSTITUTIONID = 11;
    public static final int TYPE_INSTITUTIONID = Types.INTEGER;
    public static final String NAME_INSTITUTIONID = "institutionid";

    /**
     * Column signature of type Types.VARCHAR mapped to String.
     */
    public static final int ID_SIGNATURE = 12;
    public static final int TYPE_SIGNATURE = Types.VARCHAR;
    public static final String NAME_SIGNATURE = "signature";

    /**
     * Column limited of type Types.BIT mapped to Boolean.
     */
    public static final int ID_LIMITED = 13;
    public static final int TYPE_LIMITED = Types.BIT;
    public static final String NAME_LIMITED = "limited";
    ...
    /**
     * Column picture of type Types.VARCHAR mapped to String.
     */
    public static final int ID_PICTURE = 15;
    public static final int TYPE_PICTURE = Types.VARCHAR;
    public static final String NAME_PICTURE = "picture";

    /**
     * Column gender of type Types.VARCHAR mapped to String.
     */
    public static final int ID_GENDER = 16;
    public static final int TYPE_GENDER = Types.VARCHAR;
    ...
    /**
     * Loads PersonellBean array from the personell table using its institutionid field.
     *
     * @return an array of PersonellBean 
     */
    // LOAD BY IMPORTED KEY
    public PersonellBean[] loadByInstitutionid(Integer value) throws SQLException 
    {
        Connection c = null;
        PreparedStatement ps = null;
        try 
        {
            c = getConnection();
            ps = c.prepareStatement("SELECT " + ALL_FIELDS + " FROM personell WHERE institutionid=?",ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
    ...
    /**
     * Deletes from the personell table by institutionid field.
     *
    ...
    public int deleteByInstitutionid(Integer value) throws SQLException 
    {
        ...
        {
            c = getConnection();
            ps = c.prepareStatement("DELETE FROM personell WHERE institutionid=?");
            Manager.setInteger(ps, 1, value);
            return ps.executeUpdate();
        }
        finally
    ...
    //////////////////////////////////////
    /**
     * Retrieves the InstitutionBean object from the personell.institutionid field.
     *
     * @param pObject the PersonellBean 
     * @return the associated InstitutionBean pObject
     */
    // GET IMPORTED
    public InstitutionBean getInstitutionBean(PersonellBean pObject) throws SQLException
    {
    ...
    /**
     * Associates the PersonellBean object to the InstitutionBean object.
     *
     * @param pObject the PersonellBean object to use
     * @param pObjectToBeSet the InstitutionBean object to associate to the PersonellBean 
     * @return the associated InstitutionBean pObject
     */
    // SET IMPORTED
    public PersonellBean setInstitutionBean(PersonellBean pObject,InstitutionBean pObjectToBeSet)
    {
    ...
    public PersonellBean save(PersonellBean pObject) throws SQLException
    {
        ...
        try
        {
            ...
            { // SAVE 
                ...
                if (pObject.isSignatureModified()) {
                    if (_dirtyCount>0) {
                        _sql.append(",");
                    }
                    _sql.append("signature");
                    _dirtyCount++;
                }

                if (pObject.isLimitedModified()) {
                    if (_dirtyCount>0) {
                        _sql.append(",");
                    }
                    _sql.append("limited");
                ...
                if (pObject.isSignatureModified()) {
                    ps.setString(++_dirtyCount, pObject.getSignature());
                }
    
                if (pObject.isLimitedModified()) {
                    Manager.setBoolean(ps, ++_dirtyCount, pObject.getLimited());
                }
                ...
                if (pObject.isPictureModified()) {
                    ps.setString(++_dirtyCount, pObject.getPicture());
                }
    
                if (pObject.isGenderModified()) {
                    ps.setString(++_dirtyCount, pObject.getGender());
                }
    ...
    public PersonellBean[] loadUsingTemplate(PersonellBean pObject) throws SQLException
    {
        ...
        try
        {
            int _dirtyCount = 0;
             ...
             if (pObject.isSignatureModified()) {
                 _dirtyCount ++; 
                 _sqlWhere.append((_sqlWhere.length() == 0) ? " " : " AND ").append("signature= ?");
             }
    
             if (pObject.isLimitedModified()) {
                 _dirtyCount ++; 
                 _sqlWhere.append((_sqlWhere.length() == 0) ? " " : " AND ").append("limited= ?");
             }
             ...
             if (pObject.isPictureModified()) {
                 _dirtyCount ++; 
                 _sqlWhere.append((_sqlWhere.length() == 0) ? " " : " AND ").append("picture= ?");
             }
    ...
    public int deleteUsingTemplate(PersonellBean pObject) throws SQLException
    {
        ...
        try 
        {
            ...
            if (pObject.isSignatureInitialized()) {
                if (_dirtyAnd > 0)
                    sql.append(" AND ");
                sql.append("signature").append("=?");
                _dirtyAnd ++;
            }
    
            if (pObject.isLimitedInitialized()) {
                if (_dirtyAnd > 0)
                    sql.append(" AND ");
                sql.append("limited").append("=?");
                _dirtyAnd ++;
            }
            ...
            if (pObject.isPictureInitialized()) {
                if (_dirtyAnd > 0)
                    sql.append(" AND ");
                sql.append("picture").append("=?");
                _dirtyAnd ++;
            }
    ...
    public PersonellBean decodeRow(ResultSet rs) throws SQLException
    {
        ...
        pObject.setInstitutionid(Manager.getInteger(rs, 12));
        pObject.setSignature(rs.getString(13));
        pObject.setLimited(Manager.getBoolean(rs, 14));
        pObject.setCompanyid(Manager.getInteger(rs, 15));
        pObject.setPicture(rs.getString(16));
        pObject.setGender(rs.getString(17));
    ...
    public PersonellBean decodeRow(ResultSet rs, int[] fieldList) throws SQLException
    {
        ...
        for(int i = 0; i < fieldList.length; i++)
        {
            switch(fieldList[i]) {
                ...
                case ID_SIGNATURE:
                    ++pos;
                    pObject.setSignature(rs.getString(pos));
                    break;
                case ID_LIMITED:
                    ++pos;
                    pObject.setLimited(Manager.getBoolean(rs, pos));
                    break;
                case ID_COMPANYID:
                    ++pos;
                ...
                case ID_PICTURE:
                    ++pos;
                    pObject.setPicture(rs.getString(pos));
                    break;
                case ID_GENDER:
                    ++pos;
                    pObject.setGender(rs.getString(pos));
                    break;
            }
        }
        pObject.isNew(false);
