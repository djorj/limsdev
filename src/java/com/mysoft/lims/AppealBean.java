...
// extends- 
{
    ...
    private boolean appealdate_is_modified = false;
    private boolean appealdate_is_initialized = false;
    ...
    private boolean samplenum_is_modified = false;
    private boolean samplenum_is_initialized = false;
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: appeal.contractid
    ...
    /**
     * Getter method for appealdate.
     * <br>
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: appeal.appealdate
     * <li>column size: 4
     * <li>jdbc type returned by the driver: Types.DATE
     * </ul>
     *
     * @return the value of appealdate
     */
    ...
    /**
     * Setter method for appealdate.
     * <br>
     * The new value is set only if compareTo() says it is different,
     * or if one of either the new value or the current value is null.
     * In case the new value is different, it is set and the field is marked as 'modified'.
     *
     * @param newVal the new value to be assigned to appealdate
     */
    public void setAppealdate(java.util.Date newVal) {
        if ((newVal != null && this.appealdate != null && (newVal.compareTo(this.appealdate) == 0)) || 
            (newVal == null && this.appealdate == null && appealdate_is_initialized)) {
            return; 
        } 
        this.appealdate = newVal; 
        appealdate_is_modified = true; 
        appealdate_is_initialized = true; 
    }
     ...
     * @param newVal the new value to be assigned to appealdate
     */
    public void setAppealdate(long newVal) {
        setAppealdate(new java.util.Date(newVal));
    }

    /**
     * Determines if the appealdate has been modified.
     *
     * @return true if the field has been modified, false if the field has not been modified
     */
    public boolean isAppealdateModified() {
        return appealdate_is_modified; 
    }

    /**
     * Determines if the appealdate has been initialized.
     * <br>
     * It is useful to determine if a field is null on purpose or just because it has not been initialized.
     *
     * @return true if the field has been initialized, false otherwise
     */
    public boolean isAppealdateInitialized() {
        return appealdate_is_initialized; 
    }
    ...
    /**
     * Getter method for samplenum.
     * <br>
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: appeal.samplenum
     * <li>column size: 8
     * <li>jdbc type returned by the driver: Types.DOUBLE
     * </ul>
     *
     * @return the value of samplenum
     */
    ...
    /**
     * Setter method for samplenum.
     * <br>
     * The new value is set only if compareTo() says it is different,
     * or if one of either the new value or the current value is null.
     * In case the new value is different, it is set and the field is marked as 'modified'.
     *
     * @param newVal the new value to be assigned to samplenum
     */
    public void setSamplenum(Double newVal) {
        if ((newVal != null && this.samplenum != null && (newVal.compareTo(this.samplenum) == 0)) || 
            (newVal == null && this.samplenum == null && samplenum_is_initialized)) {
            return; 
        } 
        this.samplenum = newVal; 
        samplenum_is_modified = true; 
        samplenum_is_initialized = true; 
    }
     ...
     */
    public void setSamplenum(double newVal) {
        setSamplenum(new Double(newVal));
    }

    /**
     * Determines if the samplenum has been modified.
     *
     * @return true if the field has been modified, false if the field has not been modified
     */
    public boolean isSamplenumModified() {
        return samplenum_is_modified; 
    }

    /**
     * Determines if the samplenum has been initialized.
     * <br>
     * It is useful to determine if a field is null on purpose or just because it has not been initialized.
     *
     * @return true if the field has been initialized, false otherwise
     */
    public boolean isSamplenumInitialized() {
        return samplenum_is_initialized; 
    }
    ...
    public boolean isModified() {
		...
		num_is_modified || 
		appealdate_is_modified || 
		path_is_modified || 
		samplenum_is_modified || 
		regbyid_is_modified || 
		regdate_is_modified || 
    ...
    public void resetIsModified() {
        ...
        appealdate_is_modified = false;
        path_is_modified = false;
        samplenum_is_modified = false;
     ...
     */
    public void copy(AppealBean bean) {
        setAppealid(bean.getAppealid());
        setContractid(bean.getContractid());
        setNum(bean.getNum());
        setAppealdate(bean.getAppealdate());
        setPath(bean.getPath());
        setSamplenum(bean.getSamplenum());
    ...
    public String toString() {
        return   "\n[appeal] "
                 + "\n - appeal.appealid = " + (appealid_is_initialized ? ("[" + (appealid == null ? null : appealid.toString()) + "]") : "not initialized") + ""
                 + "\n - appeal.contractid = " + (contractid_is_initialized ? ("[" + (contractid == null ? null : contractid.toString()) + "]") : "not initialized") + ""
                 + "\n - appeal.num = " + (num_is_initialized ? ("[" + (num == null ? null : num.toString()) + "]") : "not initialized") + ""
                 + "\n - appeal.appealdate = " + (appealdate_is_initialized ? ("[" + (appealdate == null ? null : appealdate.toString()) + "]") : "not initialized") + ""
                 + "\n - appeal.path = " + (path_is_initialized ? ("[" + (path == null ? null : path.toString()) + "]") : "not initialized") + ""
                 + "\n - appeal.samplenum = " + (samplenum_is_initialized ? ("[" + (samplenum == null ? null : samplenum.toString()) + "]") : "not initialized") + ""
                 + "\n - appeal.regbyid = " + (regbyid_is_initialized ? ("[" + (regbyid == null ? null : regbyid.toString()) + "]") : "not initialized") + ""
                 + "\n - appeal.regdate = " + (regdate_is_initialized ? ("[" + (regdate == null ? null : regdate.toString()) + "]") : "not initialized") + ""
                 + "\n - appeal.regionid = " + (regionid_is_initialized ? ("[" + (regionid == null ? null : regionid.toString()) + "]") : "not initialized") + ""
                 + "\n - appeal.raionid = " + (raionid_is_initialized ? ("[" + (raionid == null ? null : raionid.toString()) + "]") : "not initialized") + ""
                 + "\n - appeal.villageid = " + (villageid_is_initialized ? ("[" + (villageid == null ? null : villageid.toString()) + "]") : "not initialized") + ""
                 + "\n - appeal.deleted = " + (deleted_is_initialized ? ("[" + (deleted == null ? null : deleted.toString()) + "]") : "not initialized") + ""
                 + "\n - appeal.bringer = " + (bringer_is_initialized ? ("[" + (bringer == null ? null : bringer.toString()) + "]") : "not initialized") + ""
                 + "\n - appeal.stamp = " + (stamp_is_initialized ? ("[" + (stamp == null ? null : stamp.toString()) + "]") : "not initialized") + ""
            ;
    }
