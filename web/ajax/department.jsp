...
<script type="text/javascript">
    ...
    var pagefunction = function () {
        ...
        function run_jqgrid_function() {
            ...
            jQuery("#department").jqGrid({
                url: 'content/getdepartmentlist.jsp',
                datatype: "json",
                treeGridModel: 'adjacency',
                treeGrid: true,
                ExpandColumn: 'name',
                colNames: ['id', '<%=trs.t("დასახელება")%>', '<%=trs.t("მისამართი")%>', '<%=trs.t("ზედა დონის ორგანიზაცია")%>'],
                colModel: [
                    ...
                    {name: 'address', index: 'address', editable: true, sortable: false, align: "left", width: 200, edittype: "text", editoptions: {size: "30"}},
                    {name: 'parentid', index: 'parentid', hidden: true, editable: true, sortable: false, width: 200, edittype: "select", editoptions: {dataUrl: "content/getlablistselect.jsp",style:"width: 200px;"}, editrules: {edithidden: true}}
                ...
                autowidth: true,
                rowList: [20, 50, 100],
                pager: jQuery('#pagerdepartment'),
                sortname: 'name',
                viewrecords: true,
                sortorder: "asc",
                editurl: "content/upddepartment.jsp",
                title: "<%=trs.t("დეპარტამენტი")%>"
            })
            .navGrid("#pagerdepartment", {edit:<%=permissions[1]%>,add:<%=permissions[0]%>,del:<%=permissions[2]%>,view:false,search:false},
            ...
            $(window).on('resize.jqGrid', function () {
                jQuery("#department").jqGrid('setGridWidth', $("#content").width());
            })
