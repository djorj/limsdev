...
public class LabteststandardBean
// extends+ 
...
// extends- 
{
     ...
     * <ul>
     * <li>full name: labteststandard.labtestid
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: labteststandard.standardid
     ...
     */
    public void copy(LabteststandardBean bean) {
    ...
    public String toString() {
        return   "\n[labteststandard] "
                 + "\n - labteststandard.labtestid = " + (labtestid_is_initialized ? ("[" + (labtestid == null ? null : labtestid.toString()) + "]") : "not initialized") + ""
                 + "\n - labteststandard.standardid = " + (standardid_is_initialized ? ("[" + (standardid == null ? null : standardid.toString()) + "]") : "not initialized") + ""
            ;
    }
