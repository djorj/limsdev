...
// extends- 
{
    ...
    private String lab;
    private boolean lab_is_modified = false;
    private boolean lab_is_initialized = false;
     ...
     * <ul>
     * <li>full name: v_labtest_inst.labtestid
     * <li>column size: 4
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: v_labtest_inst.testname
     * <li>column size: -1
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: v_labtest_inst.institutionid
     * <li>column size: 4
     * <li>jdbc type returned by the driver: Types.INTEGER
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: v_labtest_inst.lab
     * <li>column size: -1
     * <li>jdbc type returned by the driver: Types.VARCHAR
     * </ul>
     *
    ...
    /**
     * Setter method for lab.
     * <br>
     * The new value is set only if compareTo() says it is different,
     * or if one of either the new value or the current value is null.
     * In case the new value is different, it is set and the field is marked as 'modified'.
     *
     * @param newVal the new value to be assigned to lab
     */
    public void setLab(String newVal) {
        if ((newVal != null && this.lab != null && (newVal.compareTo(this.lab) == 0)) || 
            (newVal == null && this.lab == null && lab_is_initialized)) {
            return; 
        } 
        this.lab = newVal; 
        lab_is_modified = true; 
        lab_is_initialized = true; 
    }

    /**
     * Determines if the lab has been modified.
     *
     * @return true if the field has been modified, false if the field has not been modified
     */
    public boolean isLabModified() {
        return lab_is_modified; 
    }

    /**
     * Determines if the lab has been initialized.
     * <br>
     * It is useful to determine if a field is null on purpose or just because it has not been initialized.
     *
     * @return true if the field has been initialized, false otherwise
     */
    public boolean isLabInitialized() {
        return lab_is_initialized; 
    }
     ...
     */
    public void copy(VLabtestInstBean bean) {
    ...
    public String toString() {
        return   "\n[v_labtest_inst] "
                 + "\n - v_labtest_inst.labtestid = " + (labtestid_is_initialized ? ("[" + (labtestid == null ? null : labtestid.toString()) + "]") : "not initialized") + ""
                 + "\n - v_labtest_inst.testname = " + (testname_is_initialized ? ("[" + (testname == null ? null : testname.toString()) + "]") : "not initialized") + ""
                 + "\n - v_labtest_inst.institutionid = " + (institutionid_is_initialized ? ("[" + (institutionid == null ? null : institutionid.toString()) + "]") : "not initialized") + ""
                 + "\n - v_labtest_inst.lab = " + (lab_is_initialized ? ("[" + (lab == null ? null : lab.toString()) + "]") : "not initialized") + ""
            ;
    }
