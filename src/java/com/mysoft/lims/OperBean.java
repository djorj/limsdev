...
// extends- 
{
     ...
     */
    public void copy(OperBean bean) {
    ...
    public String toString() {
        return   "\n[oper] "
                 + "\n - oper.operid = " + (operid_is_initialized ? ("[" + (operid == null ? null : operid.toString()) + "]") : "not initialized") + ""
                 + "\n - oper.name = " + (name_is_initialized ? ("[" + (name == null ? null : name.toString()) + "]") : "not initialized") + ""
                 + "\n - oper.type = " + (type_is_initialized ? ("[" + (type == null ? null : type.toString()) + "]") : "not initialized") + ""
            ;
    }
