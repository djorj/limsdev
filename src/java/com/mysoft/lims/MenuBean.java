...
// extends- 
{
    ...
    public String toString() {
        return   "\n[menu] "
                 ...
                 + "\n - menu.icon = " + (icon_is_initialized ? ("[" + (icon == null ? null : icon.toString()) + "]") : "not initialized") + ""
                 + "\n - menu.companyid = " + (companyid_is_initialized ? ("[" + (companyid == null ? null : companyid.toString()) + "]") : "not initialized") + ""
            ;
    }
