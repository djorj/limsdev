...
String order = "order by "+sidx+" "+sord+", personelltypeid";
...
for(int i=0;i<personelltypes.length;i++){
    ...
    ob.put("id",personelltypes[i].getPersonelltypeid());
    JSONArray cell = new JSONArray();
    cell.add(trs.t(personelltypes[i].getName()));
    cell.add(trs.t(personelltypes[i].getDescription()));
    cell.add(personelltypes[i].getCode());
    ob.put("cell",cell);
    rows.add(ob);
}
obj.put("rows",rows);
