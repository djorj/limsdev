...
%>
<script>
$.post("content/ordercdcgeneralenv.jsp", {}, function(data) { $("#s1").html(data); });
...
<ul class="nav nav-tabs bordered" id="ptabs">
    <li class="active">
        <a data-toggle="tab" href="content/ordercdcgeneralenv.jsp" data-target="#s1"><%=trs.t("ზოგადი ინფორმაცია")%></a>
    </li>
    <li>
        <a data-toggle="tab" href="content/ordercdcroenvg.jsp" data-target="#s2"><%=trs.t("კვლევის ობიექტი")%></a>
    </li>
    <li>
        <a data-toggle="tab" href="content/ordercdcepidenvg.jsp" data-target="#s3"><%=trs.t("ნიმუშის ინფორმაცია")%></a>
    </li>
    <li>
        <a data-toggle="tab" href="content/ordercdccustomerenvg.jsp" data-target="#s4"><%=trs.t("დამკვეთის მოთხოვნები")%></a>
    </li>
</ul>
