...
// extends- 
{
    ...
    private boolean print_is_modified = false;
    private boolean print_is_initialized = false;
    
    private Boolean export;
    private boolean export_is_modified = false;
    private boolean export_is_initialized = false;
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: plevel.personelltypeid
    ...
    /**
     * Getter method for print.
     * <br>
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: plevel.print
    ...
    /**
     * Setter method for print.
     * <br>
     * Attention, there will be no comparison with current value which
     * means calling this method will mark the field as 'modified' in all cases.
     *
     * @param newVal the new value to be assigned to print
     */
    public void setPrint(Boolean newVal) {
        if ((newVal != null && this.print != null && newVal.equals(this.print)) || 
            (newVal == null && this.print == null && print_is_initialized)) {
            return; 
        } 
        this.print = newVal; 
        print_is_modified = true; 
        print_is_initialized = true; 
    }
     ...
     */
    public void setPrint(boolean newVal) {
        setPrint(new Boolean(newVal));
    }

    /**
     * Determines if the print has been modified.
     *
     * @return true if the field has been modified, false if the field has not been modified
     */
    public boolean isPrintModified() {
        return print_is_modified; 
    }

    /**
     * Determines if the print has been initialized.
     * <br>
     * It is useful to determine if a field is null on purpose or just because it has not been initialized.
     *
     * @return true if the field has been initialized, false otherwise
     */
    public boolean isPrintInitialized() {
        return print_is_initialized; 
    }

    /**
     * Getter method for export.
     * <br>
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: plevel.export
     * <li>default value: false
     * <li>column size: 1
     * <li>jdbc type returned by the driver: Types.BIT
     * </ul>
    ...
    /**
     * Setter method for export.
     * <br>
     * Attention, there will be no comparison with current value which
     * means calling this method will mark the field as 'modified' in all cases.
     *
     * @param newVal the new value to be assigned to export
     */
    public void setExport(Boolean newVal) {
        if ((newVal != null && this.export != null && newVal.equals(this.export)) || 
            (newVal == null && this.export == null && export_is_initialized)) {
            return; 
        } 
        this.export = newVal; 
        export_is_modified = true; 
        export_is_initialized = true; 
    }
     ...
     */
    public void setExport(boolean newVal) {
        setExport(new Boolean(newVal));
    }

    /**
     * Determines if the export has been modified.
     *
     * @return true if the field has been modified, false if the field has not been modified
     */
    public boolean isExportModified() {
        return export_is_modified; 
    }

    /**
     * Determines if the export has been initialized.
     * <br>
     * It is useful to determine if a field is null on purpose or just because it has not been initialized.
     *
     * @return true if the field has been initialized, false otherwise
     */
    public boolean isExportInitialized() {
        return export_is_initialized; 
    }
    ...
    public void resetIsModified() {
        ...
        print_is_modified = false;
        export_is_modified = false;
    }
    ...
    public void copy(PlevelBean bean) {
        ...
        setPrint(bean.getPrint());
        setExport(bean.getExport());
    }
    ...
    public String toString() {
        return   "\n[plevel] "
                 ...
                 + "\n - plevel.personelltypeid = " + (personelltypeid_is_initialized ? ("[" + (personelltypeid == null ? null : personelltypeid.toString()) + "]") : "not initialized") + ""
                 ...
                 + "\n - plevel.print = " + (print_is_initialized ? ("[" + (print == null ? null : print.toString()) + "]") : "not initialized") + ""
                 + "\n - plevel.export = " + (export_is_initialized ? ("[" + (export == null ? null : export.toString()) + "]") : "not initialized") + ""
            ;
    }
