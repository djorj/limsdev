...
// extends- 
{
     ...
     */
    public void copy(LangBean bean) {
    ...
    public String toString() {
        return   "\n[lang] "
                 + "\n - lang.langid = " + (langid_is_initialized ? ("[" + (langid == null ? null : langid.toString()) + "]") : "not initialized") + ""
                 + "\n - lang.name = " + (name_is_initialized ? ("[" + (name == null ? null : name.toString()) + "]") : "not initialized") + ""
                 + "\n - lang.code = " + (code_is_initialized ? ("[" + (code == null ? null : code.toString()) + "]") : "not initialized") + ""
                 + "\n - lang.flag = " + (flag_is_initialized ? ("[" + (flag == null ? null : flag.toString()) + "]") : "not initialized") + ""
                 + "\n - lang.basic = " + (basic_is_initialized ? ("[" + (basic == null ? null : basic.toString()) + "]") : "not initialized") + ""
            ;
    }
