...
<div class="smart-form">
    ...
    <div class="row" style="margin-bottom: 5px !important;">
        <div class="col col-sm-4">
            <label class="radio" style="margin-bottom: 5px !important;"><input id="radio3-1" name="radio3" type="radio" checked><i></i><%=trs.t("პაციენი/შემთხვევა")%></label>
            <label class="radio" style="margin-bottom: 5px !important;"><input id="radio3-2" name="radio3" type="radio"><i></i><%=trs.t("გარდაცვლილი")%></label>
            <label class="radio"><input id="radio3-3" name="radio3" type="radio"><i></i><%=trs.t("კულტურა")%></label>
        </div>
        <div class="col col-sm-8" id="controlcase1">
            <label class="input" style="margin-bottom: 5px !important;"> <i class="icon-append fa fa-calendar"></i>
            ...
            <label class="input" style="margin-bottom: 5px !important;"> <i class="icon-append fa fa-pencil-square-o"></i>
        ...
        <div class="col col-sm-8" id="controlcase2">
            <label class="input" style="margin-bottom: 5px !important;"> <i class="icon-append fa fa-calendar"></i>
        ...
        <div class="col col-sm-8" id="controlcase3">
            <label class="input" style="margin-bottom: 5px !important;"> <i class="icon-append fa fa-pencil-square-o"></i>
            ...
            <label class="input" style="margin-bottom: 5px !important;"> <i class="icon-append fa fa-list-ol"></i>
            ...
            <label class="input" style="margin-bottom: 5px !important;"> <i class="icon-append fa fa-clock-o"></i>
