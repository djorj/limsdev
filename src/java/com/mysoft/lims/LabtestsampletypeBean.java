...
public class LabtestsampletypeBean
// extends+ 
...
// extends- 
{
     ...
     * <ul>
     * <li>full name: labtestsampletype.labtestid
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: labtestsampletype.sampletypeid
     ...
     */
    public void copy(LabtestsampletypeBean bean) {
    ...
    public String toString() {
        return   "\n[labtestsampletype] "
                 + "\n - labtestsampletype.labtestid = " + (labtestid_is_initialized ? ("[" + (labtestid == null ? null : labtestid.toString()) + "]") : "not initialized") + ""
                 + "\n - labtestsampletype.sampletypeid = " + (sampletypeid_is_initialized ? ("[" + (sampletypeid == null ? null : sampletypeid.toString()) + "]") : "not initialized") + ""
            ;
    }
