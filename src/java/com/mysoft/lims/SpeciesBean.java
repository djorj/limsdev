...
// extends- 
{
     ...
     * <ul>
     * <li>full name: species.speciesid
     * <li>column size: 4
     ...
     */
    public void copy(SpeciesBean bean) {
    ...
    public String toString() {
        return   "\n[species] "
                 + "\n - species.speciesid = " + (speciesid_is_initialized ? ("[" + (speciesid == null ? null : speciesid.toString()) + "]") : "not initialized") + ""
                 + "\n - species.name = " + (name_is_initialized ? ("[" + (name == null ? null : name.toString()) + "]") : "not initialized") + ""
            ;
    }
