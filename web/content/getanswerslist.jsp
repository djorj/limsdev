...
if(barcode.trim().length() > 0)
    where += " and (contractsampleitemid::text like '%"+barcode.trim().replaceAll("'", "''") +"' or contractsampleitemid in (select parentid from contractsampleitem where barcode::text like '%"+barcode.trim().replaceAll("'", "''")+"') or contractsampleitemid in (select contractsampleitemid from contractsampleitem where parentid::text like '%"+barcode.trim().replaceAll("'", "''")+"'))";
...
for(int i=0;i<res.length;i++){
    ...
    if(level == 3 && res[i].getInstitutionid().intValue() >= 11 && res[i].getInstitutionid().intValue() >= 15)
    ...
    String bcode = res[i].getBarcode().toString()+" <span style='cursor: pointer; margin-top: -20px;' class='pull-right'><a class='btn btn-info btn-xs' onclick=\"printAnswer2("+((res[i].getAppealid() == null) ? 0:res[i].getAppealid())+","+((res[i].getActid() == null) ? 0:res[i].getActid())+","+res[i].getContractid()+","+res[i].getSampletypeid()+","+res[i].getBarcode()+")\" style='padding: 1px 7px !important;'><i class='fa fa-print'></i> </a></span>";
    ...
    cell.add("<button class=\"btn btn-primary\" onclick=\"printAnswer2("+((res[i].getAppealid() == null) ? 0:res[i].getAppealid())+","+((res[i].getActid() == null) ? 0:res[i].getActid())+","+res[i].getContractid()+","+res[i].getSampletypeid()+","+res[i].getBarcode()+")\"><i class=\"fa fa-print\"></i> </button>");
