    ...
    var pagefunction = function () {
        ...
        function run_jqgrid_function() {
            jQuery("#units").jqGrid({
                ...
                viewrecords: true,
                sortorder: "asc",
                editurl: "content/updunits.jsp",
                title: "<%=trs.t("ერთეულები")%>"
            })
            .jqGrid('bindKeys')
            .jqGrid('filterToolbar', { searchOnEnter: true, enableClear: true })
            .navGrid("#pagerunits", {edit:<%=permissions[1]%>,add:<%=permissions[0]%>,del:<%=permissions[2]%>,view:false,search:false},
            ...
            $(window).on('resize.jqGrid', function () {
                jQuery("#units").jqGrid('setGridWidth', $("#content").width());
            })
