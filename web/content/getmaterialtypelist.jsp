...
String order = "order by "+sidx+" "+sord+", sampletypeid";

SampletypeBean[] tests = SampletypeManager.getInstance().loadByWhere(where+" "+order+" "+limit);
...
for(int i=0;i<tests.length;i++){
    ...
    ob.put("id",tests[i].getSampletypeid());
