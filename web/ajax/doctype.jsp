...
<script type="text/javascript">
    ...
    var pagefunction = function () {
        ...
        function run_jqgrid_function() {
            ...
            jQuery("#doctypetype").jqGrid({
                url: 'content/getdoctypelist.jsp',
                datatype: "json",
...
//                ExpandColumn: 'contact',
                ...
                autowidth: true,
                rowList: [20, 50, 100],
                pager: jQuery('#pagerdoctypetype'),
                sortname: 'name',
                viewrecords: true,
                sortorder: "asc",
                editurl: "content/upddoctypetype.jsp",
                title: "<%=trs.t("დამკვეთის ტიპი")%>"
            });
            jQuery("#doctypetype").jqGrid('navGrid', "#pagerdoctypetype", {
                edit: false,
                add: false,
                del: true,
                view: false,
                search: false
            }).navButtonAdd('#pagerdoctypetype', {
                caption: "",
                buttonicon: "ui-icon-1",
                onClickButton: function () {
                    $("#doctypetypeModal").modal("show");
                },
                position: "last"
            }).navButtonAdd('#pagerdoctypetype', {
                caption: "",
            ...
            jQuery("#doctypetype").jqGrid('inlineNav', "#pagerdoctypetype");
            ...
            $(window).on('resize.jqGrid', function () {
                jQuery("#doctypetype").jqGrid('setGridWidth', $("#content").width());
            })
...
<div class="table-size1">
    <table id="doctypetype"></table>
    <div id="pagerdoctypetype"></div>
</div>
<div class="modal fade" id="doctypetypeModal" tabindex="-1" role="dialog" aria-labelledby="iconsModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><%=trs.t("დოკუმენტის ტიპი")%></h4>
            </div>
