                    ...
                    <div class="row">
                        <div class="col col-4">
                            ...
                            <section class="col col-md-12">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-btn">
                                        <button class="btn btn-success"  data-original-title="<%=trs.t("კონტრაგენტის დამატება")%>" type="button" onclick="addContragent()">
                                            <i class="fa fa-plus"></i>
                                        </button>
                                    </div>
                                    <div class="input-group-btn" style="display: none;" id="editcontragentbtn">
                                        <button class="btn btn-warning"  data-original-title="<%=trs.t("კონტრაგენტის რედაქტირება")%>" type="button" onclick="editContragent()">
                                            <i class="fa fa-pencil"></i>
                                        </button>
                                    </div>
                                    <div class="input-group-btn">
                                        <button class="btn btn-danger clearbtn"  data-original-title="<%=trs.t("გასუთავება")%>" type="button" onclick="clearContragent()">
                            ...
                            <section class="col col-md-12" id="contract-field" style="display: none;">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-btn">
                                        <button class="btn btn-warning"  data-original-title="<%=trs.t("ხელშეკრულების რედაქტირება")%>" type="button" onclick="editContract()">
                                            <i class="fa fa-pencil"></i>
                                        </button>
                                    </div>
                                    <div class="input-group-btn">
                                        <button class="btn btn-danger clearbtn"  data-original-title="<%=trs.t("გასუთავება")%>" type="button" onclick="clearContract()">
                                            <i class="fa fa-times"></i>
                                        </button>
                                    </div>
                                    <div class="input-group-btn">
                            ...
                            <section class="col col-md-12" id="sample-field" style="display: none;">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-btn">
                                        <button class="btn btn-default" data-original-title="<%=trs.t("ყუთის რეგისტრაციის რეჟიმი")%>" id="boxmode" >
                                            <i class="fa fa-briefcase"></i>
                                        </button>
                                    </div>
                                    <div class="input-group-btn">
                                        <button class="btn btn-warning" data-original-title="<%=trs.t("ნიმუშის რედაქტირება")%>" type="button" onclick="editSample();return false;">
                                            <i class="fa fa-pencil"></i>
                                        </button>
                                    </div>
                                    <%-- div class="input-group-btn">
                            ...
                            <section class="col col-md-12" id="appeal-field" style="display: none;">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-btn">
                                        <button class="btn btn-warning" type="button" data-original-title="<%=trs.t("მიმართვის რედაქტირება")%>" onclick="editAppeal()">
                                            <i class="fa fa-pencil"></i>
                                        </button>
                                    </div>
                                    <div class="input-group-btn">
                            ...
                            <section class="col col-md-12" id="act-field" style="display: none;">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-btn">
                                        <button class="btn btn-warning" type="button" data-original-title="<%=trs.t("აქტის რედაქტირება")%>" onclick="editAct()">
                                            <i class="fa fa-pencil"></i>
                                        </button>
                                    </div>
                                    <div class="input-group-btn">
                        ...
                        <div class="col col-8">
                            ...
                            <div class="bordered-box rightside editform" id="contract-box" style="display: none;">
                                ...
                                <h2 id="frmcontracttitle"><%=trs.t("ახალი ხელშეკრულების დამატება")%></h2>
                                <section class="col col-md-4">
                                    <label class="select">
...
<div class="modal fade" id="msgModal" tabindex="-1" role="dialog" aria-labelledby="iconsModalLabel" aria-hidden="true">
    <div class="modal-dialog large">
        <div class="modal-content">
            ...
            <footer class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><%=trs.t("დახურვა")%></button>
                <button type="button" class="btn btn-success" onclick="submitClosing(); return false;"><%=trs.t("დასრულება")%></button>
            </footer>
        </div>
    </div>
</div>
...
function showmsg() {
    $("#msgModal").modal("show");
    $("#frmclosingbody").load("api/load_closing_form.jsp?contractid="+$("#contract").val(), function (json) {
        var cd = new Date();
    ...
    var pagefunction = function () {
       ...
       function run_jqgrid_function() {
        ...
        var res = getObject({contractid: cid, obj:"contractsample"});
        var opts = res.data;
        var act='active';
        ...
        for (i=0; i<n; i++) {
            ...
            jQuery("#gridanalysis"+i).jqGrid({
                ...
                url: 'content/getcontractanalysislist.jsp?contractid='+cid+'&sampleid='+opts[i].id,
                datatype: "json",
    ...
    var pagefunction2 = function () {
       ...
       function run_jqgrid_function() {
            ...
            jQuery("#sampletable").jqGrid({
                url: 'content/getcontractsamplelist.jsp?contractid='+$("#contract").val(),
                datatype: "json",
                treeGrid: true,
                treeGridModel: "adjacency",
                ExpandColumn: "sample",
                colNames: ['id', '<%=trs.t("ნიმუში")%>', '<%=trs.t("შტრიხკოდი")%>', '<%=trs.t("საველე.&nbsp;N")%>', '<%=trs.t("ცხოველის.&nbsp;N")%>', '<%=trs.t("რაოდენობა")%>', '<%=trs.t("კვლ.")%>', '<%=trs.t("მოქმედება")%>', '<input type="checkbox" id="selall" onclick="selall()">'],
                colModel: [
                    {name: 'id', index: 'id', width: 1, hidden: true, key: true},
...
//            $("#act").select2('data', {id: rs.data, text: rs.data.num, selected: true});
    ...
    $(document).on("change", "#sample", function () {
        ...
        {
            sendRequest("api/setsampletype.jsp",{oper:"add",contractid:$("#contract").val(),sampleid:v},cbAddSample);
        }
        else
        {
...
function editAppeal() {
    ...
    else
    {
        ...
        $(".rightside").hide();
        $("#appeal-box").show();
        $("#frmappealtitle").html('<%=trs.t("მიმართვის რედაქტირება")%>');
    }
}
function addAppeal() {
    clearAppealForm();
...
function editAct() {
    ...
    else
    {
        ...
        $(".rightside").hide();
        $("#act-box").show();
        $("#frmacttitle").html('<%=trs.t("აქტის რედაქტირება")%>');
...
function cbAddSample(res)
{
    ...
    else
    {
        ...
        $("#sample-box").show();
        resetAnalysis();
        $("#sampletable").jqGrid('setGridParam',{url:"content/getcontractsamplelist.jsp?contractid="+$("#contract").val()}).trigger("reloadGrid"); 
    }
}
