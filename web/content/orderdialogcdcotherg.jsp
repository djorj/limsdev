...
<ul class="nav nav-tabs bordered" id="ptabs">
    ...
    <li>
        <a data-toggle="tab" href="content/ordercdcsamleotherg.jsp" data-target="#s2"><%=trs.t("ნიმუში")%></a>
    </li>
    <li>
        <a data-toggle="tab" href="content/ordercdccustomerotherg.jsp" data-target="#s3"><%=trs.t("დამკვეთის მოთხოვნები")%></a>
    </li>
</ul>
