...
public class TunitBean
// extends+ 

// extends- 
{
    private Integer tunitid;
    private boolean tunitid_is_modified = false;
    private boolean tunitid_is_initialized = false;
    ...
    /**
     * Getter method for tunitid.
     * <br>
     * PRIMARY KEY.<br>
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: tunit.tunitid
     * <li>column size: 4
     * <li>jdbc type returned by the driver: Types.INTEGER
     * </ul>
     *
     * @return the value of tunitid
     */
    ...
    /**
     * Setter method for tunitid.
     * <br>
     * The new value is set only if compareTo() says it is different,
     * or if one of either the new value or the current value is null.
     * In case the new value is different, it is set and the field is marked as 'modified'.
     *
     * @param newVal the new value to be assigned to tunitid
     */
    public void setTunitid(Integer newVal) {
        if ((newVal != null && this.tunitid != null && (newVal.compareTo(this.tunitid) == 0)) || 
            (newVal == null && this.tunitid == null && tunitid_is_initialized)) {
            return; 
        } 
        this.tunitid = newVal; 
        tunitid_is_modified = true; 
        tunitid_is_initialized = true; 
    }
     ...
     * @param newVal the new value to be assigned to tunitid
     */
    public void setTunitid(int newVal) {
        setTunitid(new Integer(newVal));
    }

    /**
     * Determines if the tunitid has been modified.
     *
     * @return true if the field has been modified, false if the field has not been modified
     */
    public boolean isTunitidModified() {
        return tunitid_is_modified; 
    }

    /**
     * Determines if the tunitid has been initialized.
     * <br>
     * It is useful to determine if a field is null on purpose or just because it has not been initialized.
     *
     * @return true if the field has been initialized, false otherwise
     */
    public boolean isTunitidInitialized() {
        return tunitid_is_initialized; 
    }
     ...
     */
    public void copy(TunitBean bean) {
        setTunitid(bean.getTunitid());
    ...
    public String toString() {
        return   "\n[tunit] "
                 + "\n - tunit.tunitid = " + (tunitid_is_initialized ? ("[" + (tunitid == null ? null : tunitid.toString()) + "]") : "not initialized") + ""
                 + "\n - tunit.countryid = " + (countryid_is_initialized ? ("[" + (countryid == null ? null : countryid.toString()) + "]") : "not initialized") + ""
                 + "\n - tunit.name = " + (name_is_initialized ? ("[" + (name == null ? null : name.toString()) + "]") : "not initialized") + ""
                 + "\n - tunit.code = " + (code_is_initialized ? ("[" + (code == null ? null : code.toString()) + "]") : "not initialized") + ""
                 + "\n - tunit.punitid = " + (punitid_is_initialized ? ("[" + (punitid == null ? null : punitid.toString()) + "]") : "not initialized") + ""
            ;
    }
