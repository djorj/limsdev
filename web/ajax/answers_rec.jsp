                ...
                <div class="col-sm-12">
                    ...
                    <section class="col custwidth">
                        <label class="input"> <i class="icon-append fa fa-barcode"></i>
                            <input placeholder="<%=trs.t("ბარკოდი")%>" name="reqbarcode" id="reqbarcode" type="text" onkeydown="searchonenterans">
                        </label>
                    </section>
                    <section class="col custwidth">
                        <label class="select">
...
<script type="text/javascript">
    ...
    function confirm2(cellvalue, options, rowObject){
        var level1 = rowObject[9];
        var tp = "warning";
        if(Number(cellvalue) > 0){
            tp = "success";
        }
        var btn = '<button class="btn btn-'+tp+'" onclick="setconfirm2('+rowObject[12]+',2)"><i class="fa fa-check"></i> </button>';
        if(level1 == 0)
            btn = "";
        return btn;
    }
    ...
    function confirm3(cellvalue, options, rowObject){
        var level2 = rowObject[10];
        var tp = "warning";
        if(Number(cellvalue) > 0){
            tp = "success";
        }
        var btn = '<button class="btn btn-'+tp+'" onclick="setconfirm2('+rowObject[12]+',3)"><i class="fa fa-check"></i> </button>';
        if(level2 == 0)
            btn = "";
        return btn;
    }
