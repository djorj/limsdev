 ...
 * @author djorj
 */
public class massiveBcode extends HttpServlet {
    ...
    protected void doGet( HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            Document document = new Document(r,6f,6f,2f,1f);
            
            JSONArray ar = JSONArray.fromObject((String)request.getSession().getAttribute("MASSIVEBCODEPRINT"));
            ...
            for(int i=0;i<ar.size();i++){
                ...
                Image img = Image.getInstance(new java.net.URL(url+"&msg="+o.getString("msg").trim()));
                img.scaleToFit(r1);
                ...
                if(o.getString("scenter").trim().length() > 0){
                    com.itextpdf.text.Phrase ph = new com.itextpdf.text.Phrase(new com.itextpdf.text.Chunk(o.getString("scenter").trim(),font));
                ...
                if(request.getParameter("notxt") == null || !request.getParameter("notxt").equalsIgnoreCase("true")){
                    com.itextpdf.text.Phrase ph = new com.itextpdf.text.Phrase(new com.itextpdf.text.Chunk(o.getString("msg").trim(),font));
