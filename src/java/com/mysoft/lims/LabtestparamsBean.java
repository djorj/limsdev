...
public class LabtestparamsBean
// extends+ 
...
// extends- 
{
     ...
     * <ul>
     * <li>full name: labtestparams.labtestid
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: labtestparams.sampletypeid
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: labtestparams.standardid
     ...
     */
    public void copy(LabtestparamsBean bean) {
    ...
    public String toString() {
        return   "\n[labtestparams] "
                 + "\n - labtestparams.labtestid = " + (labtestid_is_initialized ? ("[" + (labtestid == null ? null : labtestid.toString()) + "]") : "not initialized") + ""
                 + "\n - labtestparams.sampletypeid = " + (sampletypeid_is_initialized ? ("[" + (sampletypeid == null ? null : sampletypeid.toString()) + "]") : "not initialized") + ""
                 + "\n - labtestparams.standardid = " + (standardid_is_initialized ? ("[" + (standardid == null ? null : standardid.toString()) + "]") : "not initialized") + ""
            ;
    }
