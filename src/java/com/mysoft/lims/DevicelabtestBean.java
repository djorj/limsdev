...
public class DevicelabtestBean
// extends+ 
...
// extends- 
{
     ...
     * <ul>
     * <li>full name: devicelabtest.deviceid
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: devicelabtest.labtestid
     ...
     */
    public void copy(DevicelabtestBean bean) {
    ...
    public String toString() {
        return   "\n[devicelabtest] "
                 + "\n - devicelabtest.deviceid = " + (deviceid_is_initialized ? ("[" + (deviceid == null ? null : deviceid.toString()) + "]") : "not initialized") + ""
                 + "\n - devicelabtest.labtestid = " + (labtestid_is_initialized ? ("[" + (labtestid == null ? null : labtestid.toString()) + "]") : "not initialized") + ""
            ;
    }
