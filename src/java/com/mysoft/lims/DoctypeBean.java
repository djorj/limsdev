...
// extends- 
{
     ...
     * <ul>
     * <li>full name: doctype.doctypeid
     * <li>column size: 4
     ...
     */
    public void copy(DoctypeBean bean) {
    ...
    public String toString() {
        return   "\n[doctype] "
                 + "\n - doctype.doctypeid = " + (doctypeid_is_initialized ? ("[" + (doctypeid == null ? null : doctypeid.toString()) + "]") : "not initialized") + ""
                 + "\n - doctype.name = " + (name_is_initialized ? ("[" + (name == null ? null : name.toString()) + "]") : "not initialized") + ""
            ;
    }
